...
var useLocale = (componentName, defaultLocale) => {
  const fullLocale = React9.useContext(context_default2);
...
var LocaleProvider = (props) => {
  ...
  return React10.createElement(context_default2.Provider, {
...
var ConfigProvider = (props) => {
  ...
  const antLocale = React33.useContext(context_default2);
...
var defaultReactRender = (node2, container) => {
  if (true) {
    const majorVersion = Number.parseInt(React34.version.split(".")[0], 10);
...
// node_modules/rc-notification/es/Notice.js
var Notify = React35.forwardRef(function(props, ref) {
  ...
  var _React$useState = React35.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), hovering = _React$useState2[0], setHovering = _React$useState2[1];
  var _React$useState3 = React35.useState(0), _React$useState4 = _slicedToArray(_React$useState3, 2), percent = _React$useState4[0], setPercent = _React$useState4[1];
  var _React$useState5 = React35.useState(0), _React$useState6 = _slicedToArray(_React$useState5, 2), spentTime = _React$useState6[0], setSpentTime = _React$useState6[1];
  ...
  var closableObj = React35.useMemo(function() {
  ...
  return React35.createElement("div", _extends({}, divProps, {
    ref,
    className: (0, import_classnames2.default)(noticePrefixCls, className, _defineProperty({}, "".concat(noticePrefixCls, "-closable"), closable)),
    style: style2,
  ...
  }, content), closable && React35.createElement("a", _extends({
    tabIndex: 0,
  ...
  }), closableObj.closeIcon), mergedShowProgress && React35.createElement("progress", {
...
var NotificationContext = import_react17.default.createContext({});
var NotificationProvider = function NotificationProvider2(_ref) {
  var children = _ref.children, classNames5 = _ref.classNames;
  return import_react17.default.createElement(NotificationContext.Provider, {
    value: {
...
var NoticeList = function NoticeList2(props) {
  ...
  var _useContext = (0, import_react18.useContext)(NotificationContext), ctxCls = _useContext.classNames;
  var dictRef = (0, import_react18.useRef)({});
  var _useState = (0, import_react18.useState)(null), _useState2 = _slicedToArray(_useState, 2), latestNotice = _useState2[0], setLatestNotice = _useState2[1];
  var _useState3 = (0, import_react18.useState)([]), _useState4 = _slicedToArray(_useState3, 2), hoverKeys = _useState4[0], setHoverKeys = _useState4[1];
  ...
  return import_react18.default.createElement(CSSMotionList_default, _extends({
    key: placement,
    className: (0, import_classnames3.default)(prefixCls, "".concat(prefixCls, "-").concat(placement), ctxCls === null || ctxCls === void 0 ? void 0 : ctxCls.list, className, _defineProperty(_defineProperty({}, "".concat(prefixCls, "-stack"), !!stack), "".concat(prefixCls, "-stack-expanded"), expanded)),
    style: style2,
    keys: keys2,
    motionAppear: true
  }, placementMotion, {
    ...
    return import_react18.default.createElement("div", {
      ref: nodeRef,
      className: (0, import_classnames3.default)("".concat(prefixCls, "-notice-wrapper"), motionClassName, configClassNames === null || configClassNames === void 0 ? void 0 : configClassNames.wrapper),
    ...
    }, import_react18.default.createElement(Notice_default, _extends({}, restConfig, {
      ...
      styles: configStyles,
      className: (0, import_classnames3.default)(configClassName, ctxCls === null || ctxCls === void 0 ? void 0 : ctxCls.notice),
      style: configStyle,
      times,
      key,
      eventKey: key,
...
// node_modules/rc-notification/es/Notifications.js
var Notifications = React38.forwardRef(function(props, ref) {
  ...
  var _React$useState = React38.useState([]), _React$useState2 = _slicedToArray(_React$useState, 2), configList = _React$useState2[0], setConfigList = _React$useState2[1];
  ...
  var _React$useState3 = React38.useState({}), _React$useState4 = _slicedToArray(_React$useState3, 2), placements = _React$useState4[0], setPlacements = _React$useState4[1];
  ...
  var emptyRef = React38.useRef(false);
  React38.useEffect(function() {
  ...
  return (0, import_react_dom2.createPortal)(React38.createElement(React38.Fragment, null, placementList.map(function(placement) {
    var placementConfigList = placements[placement];
    var list = React38.createElement(NoticeList_default, {
      key: placement,
...
function useNotification() {
  ...
  var _rootConfig$getContai = rootConfig.getContainer, getContainer = _rootConfig$getContai === void 0 ? defaultGetContainer : _rootConfig$getContai, motion = rootConfig.motion, prefixCls = rootConfig.prefixCls, maxCount = rootConfig.maxCount, className = rootConfig.className, style2 = rootConfig.style, onAllRemoved = rootConfig.onAllRemoved, stack = rootConfig.stack, renderNotifications2 = rootConfig.renderNotifications, shareConfig = _objectWithoutProperties(rootConfig, _excluded4);
  var _React$useState = React39.useState(), _React$useState2 = _slicedToArray(_React$useState, 2), container = _React$useState2[0], setContainer = _React$useState2[1];
  var notificationsRef = React39.useRef();
  var contextHolder = React39.createElement(Notifications_default, {
    container,
  ...
  var _React$useState3 = React39.useState([]), _React$useState4 = _slicedToArray(_React$useState3, 2), taskQueue2 = _React$useState4[0], setTaskQueue = _React$useState4[1];
  ...
  var api = React39.useMemo(function() {
    return {
      open: open2,
      close: function close(key) {
        setTaskQueue(function(queue) {
...
var useClosable = (propCloseCollection, contextCloseCollection, fallbackCloseCollection = EmptyFallbackCloseCollection) => {
  ...
  const mergedFallbackCloseCollection = import_react19.default.useMemo(() => Object.assign({
    closeIcon: import_react19.default.createElement(CloseOutlined_default, null)
  }, fallbackCloseCollection), [fallbackCloseCollection]);
  const mergedClosableConfig = import_react19.default.useMemo(() => {
  ...
  return import_react19.default.useMemo(() => {
    ...
    if (mergedCloseIcon !== null && mergedCloseIcon !== void 0) {
      ...
      mergedCloseIcon = import_react19.default.isValidElement(mergedCloseIcon) ? import_react19.default.cloneElement(mergedCloseIcon, Object.assign(Object.assign(Object.assign({}, mergedCloseIcon.props), {
        "aria-label": (_b = (_a = mergedCloseIcon.props) === null || _a === void 0 ? void 0 : _a["aria-label"]) !== null && _b !== void 0 ? _b : contextLocale.close
      }), ariaOrDataProps)) : import_react19.default.createElement("span", Object.assign({
...
var useForceUpdate = () => {
  return import_react20.default.useReducer((ori) => ori + 1, 0);
};

// node_modules/antd/es/_util/hooks/useMergeSemantic.js
var React42 = __toESM(require_react());
var import_classnames4 = __toESM(require_classnames());
function mergeClassNames(schema, ...classNames5) {
  const mergedSchema = schema || {};
  return classNames5.reduce((acc, cur) => {
    Object.keys(cur || {}).forEach((key) => {
      ...
      if (keySchema && typeof keySchema === "object") {
        if (curVal && typeof curVal === "object") {
          ...
          if (defaultField) {
            acc[key] = acc[key] || {};
            acc[key][defaultField] = (0, import_classnames4.default)(acc[key][defaultField], curVal);
          }
        }
      } else {
        acc[key] = (0, import_classnames4.default)(acc[key], curVal);
      }
    });
    return acc;
  }, {});
}
function useSemanticClassNames(schema, ...classNames5) {
  return React42.useMemo(() => mergeClassNames.apply(void 0, [schema].concat(classNames5)), [classNames5, schema]);
}
...
var usePatchElement = () => {
  const [elements, setElements] = React43.useState([]);
  const patchElement = React43.useCallback((element) => {
...
var useSyncState2 = (initialValue) => {
  const ref = React44.useRef(initialValue);
...
var TypeIcon = {
  info: React47.createElement(InfoCircleFilled_default, null),
  success: React47.createElement(CheckCircleFilled_default, null),
  error: React47.createElement(CloseCircleFilled_default, null),
  warning: React47.createElement(ExclamationCircleFilled_default, null),
  loading: React47.createElement(LoadingOutlined_default, null)
};
var PureContent = ({
  prefixCls,
  type,
...
}, icon || TypeIcon[type], React47.createElement("span", null, children));
var PurePanel = (props) => {
  const {
  ...
  return wrapCSSVar(React47.createElement(Notice_default, Object.assign({}, restProps, {
    prefixCls,
    className: (0, import_classnames5.default)(className, hashId, `${prefixCls}-notice-pure-panel`, cssVarCls, rootCls),
    eventKey: "pure",
    duration: null,
    content: React47.createElement(PureContent, {
      prefixCls,
      type,
      icon
    }, content)
...
var Wrapper = ({
  ...
  const rootCls = useCSSVarCls_default(prefixCls);
  const [wrapCSSVar, hashId, cssVarCls] = style_default(prefixCls, rootCls);
  return wrapCSSVar(React48.createElement(NotificationProvider_default, {
    classNames: {
...
var renderNotifications = (node2, {
  prefixCls,
  key
}) => React48.createElement(Wrapper, {
  prefixCls,
  key
}, node2);
var Holder = React48.forwardRef((props, ref) => {
  const {
    top,
    prefixCls: staticPrefixCls,
  ...
  const mergedCloseIcon = React48.createElement("span", {
    className: `${prefixCls}-close-x`
  }, React48.createElement(CloseOutlined_default, {
  ...
  React48.useImperativeHandle(ref, () => Object.assign(Object.assign({}, api), {
    prefixCls,
    message: message2
  }));
  return holder;
...
function useInternalMessage(messageConfig) {
  ...
  const warning3 = devUseWarning("Message");
  const wrapAPI = React48.useMemo(() => {
    const close = (key) => {
      var _a;
    ...
    const open2 = (config) => {
      if (!holderRef.current) {
        true ? warning3(false, "usage", "You are calling notice in render which will break in React 18 concurrent mode. Please trigger in effect instead.") : void 0;
        const fakeResult = () => {
        };
        fakeResult.then = () => {
        };
      ...
      return wrapPromiseFn((resolve) => {
        originOpen(Object.assign(Object.assign({}, restConfig), {
          key: mergedKey,
          content: React48.createElement(PureContent, {
            prefixCls,
            type,
            icon
          }, content),
  ...
  return [wrapAPI, React48.createElement(Holder, Object.assign({
    key: "message-holder"
  }, messageConfig, {
    ref: holderRef
  }))];
...
var GlobalHolder = import_react25.default.forwardRef((props, ref) => {
  const {
    messageConfig,
    sync
  } = props;
  ...
  const appConfig = (0, import_react25.useContext)(AppConfigContext);
  const [api, holder] = useInternalMessage(Object.assign(Object.assign(Object.assign({}, messageConfig), {
    prefixCls
  }), appConfig.message));
  import_react25.default.useImperativeHandle(ref, () => {
...
var GlobalHolderWrapper = import_react25.default.forwardRef((_, ref) => {
  const [messageConfig, setMessageConfig] = import_react25.default.useState(getGlobalContext);
  const sync = () => {
    setMessageConfig(getGlobalContext);
  };
  import_react25.default.useEffect(sync, []);
  const global = globalConfig();
  const rootPrefixCls = global.getRootPrefixCls();
  const rootIconPrefixCls = global.getIconPrefixCls();
  const theme = global.getTheme();
  const dom = import_react25.default.createElement(GlobalHolder, {
    ref,
    sync,
    messageConfig
  });
  return import_react25.default.createElement(config_provider_default, {
...
var flushMessageQueue = () => {
  if (!message) {
    ...
    act(() => {
      ...
      reactRender2(import_react25.default.createElement(GlobalHolderWrapper, {
        ref: (node2) => {
          const {
            instance,
            sync
...
//# sourceMappingURL=chunk-VJPSIYTH.js.map
